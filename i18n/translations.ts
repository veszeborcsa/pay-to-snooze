...
const translations: Record<Language, Record<string, string>> = {
    en: {
        ...
        deleteConfirmSound: 'Delete this custom sound?',
    ...
    hu: {
        ...
        soundClassic: 'Klasszikus',
        soundGentle: 'Lágy',
        soundUrgent: 'Sürgős',
        soundDigital: 'Digitális',
        soundBells: 'Harang',
        uploadSound: '➕ Feltöltés',
        deleteSound: 'Hang törlése',
        deleteConfirmSound: 'Törlöd ezt az egyéni hangot?',
    ...
    es: {
        ...
        deleteConfirmSound: '¿Eliminar este sonido personalizado?',
    ...
    de: {
        ...
        soundGentle: 'Sanft',
        soundUrgent: 'Dringend',
        soundDigital: 'Digital',
        soundBells: 'Glocken',
        uploadSound: '➕ Hochladen',
        deleteSound: 'Ton löschen',
        deleteConfirmSound: 'Diesen benutzerdefinierten Ton löschen?',
